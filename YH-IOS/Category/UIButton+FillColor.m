...
/**
 样式1：白色背景，白色16号字体，圆角2
 */
- (void)style1{
    [self setBackgroundColor:[AppColor oneColor] forState:UIControlStateNormal];
    self.titleLabel.font = [UIFont systemFontOfSize:12];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self cornerRadius:2.0];
}
/**
 样式2：透明背景，绿色12号字体，圆角2.5,字体选中绿色非选中黑色
 */
- (void)style2{
    [self setBackgroundColor:[UIColor clearColor] forState:UIControlStateNormal];
    self.titleLabel.font = [UIFont systemFontOfSize:12];
    [self setTitleColor:[AppColor oneColor] forState:UIControlStateSelected];
    [self setTitleColor:[AppColor textColor] forState:UIControlStateNormal];
