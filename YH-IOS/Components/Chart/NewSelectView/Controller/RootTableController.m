...
- (NSMutableArray *)titleArr{
    ...
    if (!_titleArr) {
        ...
        NSMutableArray *titles = [[NSMutableArray alloc] initWithArray:[myModel modelWithArr:self.searchItems]];
        _titleArr = titles;
    }
    return _titleArr;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    SectionHeaderView *sectionView = [[SectionHeaderView alloc] initWithFrame:CGRectMake(0, 0,SCREEN_WIDTH, viewH)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.selectedToIndex == indexPath.row && self.selectedIndex == indexPath.section && self.cellH > viewH) {
        ...
        LastSectionView *lastView = [[LastSectionView alloc] initWithFrame:CGRectMake(0, viewH, SCREEN_WIDTH, viewH * nextModel.infos.count)];
