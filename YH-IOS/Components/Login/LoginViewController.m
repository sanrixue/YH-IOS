...
- (void)layoutWithIpad {
   ...
   // [_bgView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-120-[_registerBtn(70)]-(>30)-[_findPassword(70)]-120-|" options:0 metrics:nil views:ViewDict]];
