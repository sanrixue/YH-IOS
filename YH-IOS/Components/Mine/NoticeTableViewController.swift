...
class NoticeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(nib, forCellReuseIdentifier: noticeCellID)
        
        let filterView:UIButton = UIButton()
        filterView.frame = CGRect(x: SCREENWIDTH - 80, y: KtitlesViewH+3, width: 60, height: 30)
        filterView.backgroundColor = UIColor.red
        self.tableView.superview?.addSubview(filterView)
