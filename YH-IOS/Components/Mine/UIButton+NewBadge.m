...
@implementation UIButton (NewBadge)
...
- (void)badgeInit
{
    ...
    self.badgeBGColor   = [UIColor colorWithHexString:@"#6aa657"];
    self.badgeTextColor = [UIColor whiteColor];
    self.badgeFont      = [UIFont systemFontOfSize:4.0];
    self.badgePadding   = 2;
    self.badgeMinSize   = 4;
    self.badgeOriginX   = self.frame.size.width/2 + 25 + self.badge.frame.size.width + 1;
    self.badgeOriginY   = 4;
