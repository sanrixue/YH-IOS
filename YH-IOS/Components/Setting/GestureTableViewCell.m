...
- (void)initWithSubview {
    self.messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(14, 5, 120 , self.frame.size.height / 2)];
    ...
    self.changeGestureBtn = [[UIButton alloc] initWithFrame:CGRectMake(14, self.frame.size.height / 2 + 20, 100, self.frame.size.height / 2 - 10)];
