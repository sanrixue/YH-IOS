...
- (void)initWithSubview {
    ...
    self.grayArrow = [[UIImageView alloc]initWithFrame:CGRectMake(mSCREEN.size.width - 60, 0, 40 ,self.frame.size.height)];
    self.grayArrow.backgroundColor = [UIColor redColor];
