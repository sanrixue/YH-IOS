var InitiateSimpleDataTableClass = function () {
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#simpledatatableClass').dataTable({
            ...
            jQuery('#simpledatatableClass .group-checkable').change(function () {
                var set = $(".checkboxes");
            ...
            jQuery('#simpledatatableClass tbody tr .checkboxes').change(function () {
...
}();var InitiateSimpleDataTablePR = function () {
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#simpledatatablePR').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "iDisplayLength": 5,
                "oTableTools": {
                    "aButtons": [
            ...
            //Check All Functionality
            jQuery('#simpledatatablePR .group-checkable').change(function () {
                var set = $(".checkboxes");
                var checked = jQuery(this).is(":checked");
                jQuery(set).each(function () {
                    if (checked) {
            ...
            jQuery('#simpledatatablePR tbody tr .checkboxes').change(function () {
                $(this).parents('tr').toggleClass("active");
            });
...
var InitiateSimpleDataTableA7 = function () {
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#simpledatatableA7').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "iDisplayLength": 5,
                "oTableTools": {
                    "aButtons": [
            ...
            //Check All Functionality
            jQuery('#simpledatatableA7 .group-checkable').change(function () {
                var set = $(".checkboxes");
                var checked = jQuery(this).is(":checked");
                jQuery(set).each(function () {
                    if (checked) {
            ...
            jQuery('#simpledatatableA7 tbody tr .checkboxes').change(function () {
                $(this).parents('tr').toggleClass("active");
            });
...
var InitiateSimpleDataTableBU = function () {
    return {
        init: function () {
            //Datatable Initiating
            var oTable = $('#simpledatatableBU').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "iDisplayLength": 5,
                "oTableTools": {
                    "aButtons": [
            ...
            //Check All Functionality
            jQuery('#simpledatatableBU .group-checkable').change(function () {
                var set = $(".checkboxes");
                var checked = jQuery(this).is(":checked");
                jQuery(set).each(function () {
                    if (checked) {
            ...
            jQuery('#simpledatatableBU tbody tr .checkboxes').change(function () {
                $(this).parents('tr').toggleClass("active");
            });
