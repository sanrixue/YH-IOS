    ...
    generateTemplate: function(outerIndex, template) {
      ...
      for(i = 0, len = parts.length; i < len; i ++) {
        ...
        if(part_type === 'banner') {
          ...
          var temp_table_v3_configs = ReportTemplateV2.generateTablesV3(outerIndex, innerIndex, parts[i].config);
          htmlString += temp_table_v3_configs[0];
          table_v3_configs.push(temp_table_v3_configs[1]);
        }
      ...
      return [htmlString, table_v3_configs];
    },
