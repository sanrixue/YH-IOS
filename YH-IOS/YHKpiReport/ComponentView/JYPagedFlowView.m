...
@interface JYPagedFlowView ()<UIScrollViewDelegate>
...
@implementation JYPagedFlowView
...
- (void)setPageAtIndex:(NSInteger)pageIndex{
    ...
    if ((NSObject *)cell == [NSNull null]) {
        ...
        if ([cell isKindOfClass:[JYTopSinglePage class]]) {
            [(JYTopSinglePage *)cell refreshSubViewData];
        }
