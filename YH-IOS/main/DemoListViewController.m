...
- (void)viewDidLoad
{
    ...
    self.itemDefs = @[
                      @{
                          @"title": @"ScrollChartsVc",
                          @"subtitle": @"ScrollChartsVc.",
                          @"class": ScrollChartsVc.class
                          },
                      @{
                          @"title": @"生意人优化",
                          @"subtitle": @"HomeIndexVC.",
                          @"class": HomeIndexVC.class
                          },
//                      @{
//                          @"title": @"Line Chart",
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==1) {
       ...
       // [CurAppDelegate.navigationViewController pushViewController:vc animated:YES];
        return;
    }
    NSDictionary *def = self.itemDefs[indexPath.row];
